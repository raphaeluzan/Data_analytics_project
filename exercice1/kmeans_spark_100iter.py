...
def initCentroids_with_random_rdd(data,k):
	min = 0
	max = 8
	res = [(i,(random.uniform(min,max),random.uniform(min,max),random.uniform(min,max),random.uniform(min,max))) for i in range(0,k)]
...
def stats_res(a):
	print("moyenne : "+ str(mean(a)))
	print("ecart-type : " + str(stdev(a)))
	print("min : " + str(min(a)))
	print("max : "+ str(max(a)))
	print( "mediane :" + str(median(a)))
...
for i in range(0,100):
	...
	print("**********************************")
	resultat.append(intraClusterDistances)
	nbr_iteration.append(i)
	print(resultat)
	print(nbr_iteration)
